...
class CreateCheckoutSessionView(TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        try:
            id = djstripe.settings.get_subscriber_model().objects.first().id

        except AttributeError:
            id = (
                djstripe.settings.get_subscriber_model()
...
class PurchaseSubscriptionView(FormView):
    ...
    * create a Subscription using that card
    ...
    def form_valid(self, form):
        ...
        # this can be overridden with djstripe.settings.DJSTRIPE_SUBSCRIBER_MODEL
    ...
    def get_success_url(self):
        return reverse(
            "store:purchase_subscription_success",
